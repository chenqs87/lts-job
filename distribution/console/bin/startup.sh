...
JAVA_OPT="${JAVA_OPT} -jar ${BASE_DIR}/target/lts-job-console.jar"
...
nohup $JAVA ${JAVA_OPT} lts.job.console >> ${BASE_DIR}/logs/start.out 2>&1 &
echo "lts-job-console is starting，you can check the ${BASE_DIR}/logs/start.out"
